...
import { ClientProfileTab } from "./tabs/client-profile-tab"
import { ClientNotificationsTab } from "./tabs/client-notifications-tab"
import { ClientSecurityTab } from "./tabs/client-security-tab"
...
export function ClientSettingsClient({ user }: { user: ClientUserProps }) {
  ...
  const handleAvatarFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const filePath = `avatar-client-${user.id}-${Date.now()}.${ext}`
