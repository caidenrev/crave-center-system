      ...
      <form onSubmit={handlePasswordSubmit} className="space-y-5 pt-2">
        <div className="space-y-2 max-w-lg">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all text-sm font-medium"
              required
            />
            <button
              type="button"
        ...
        <div className="space-y-2 max-w-lg">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all text-sm font-medium"
            required
          />
        </div>
