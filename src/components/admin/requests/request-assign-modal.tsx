      ...
      <div className="bg-white dark:bg-slate-900 rounded-[28px] max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-200">
        ...
        <div className="py-4 space-y-3 max-h-[300px] overflow-y-auto pr-1">
          {workersList.length === 0 ? (
            <div className="p-6 text-center text-xs text-slate-500 font-medium">
              Belum ada anggota tim yang terdaftar di database. Silakan setujui pelamar di menu Lamaran Pekerja terlebih dahulu.
            </div>
          ) : (
        ...
        <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-slate-100 dark:border-slate-800">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white text-xs font-bold shadow-md shadow-blue-500/20 transition-all"
          >
            Confirm Assignment
          </button>
        </div>
