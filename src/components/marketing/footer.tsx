...
export function Footer() {
  return (
    <footer className="border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 text-zinc-600 dark:text-zinc-400 relative overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-px bg-gradient-to-r from-transparent via-zinc-200 dark:via-zinc-800 to-transparent"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li><Link href="/#features" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Fitur Utama</Link></li>
              <li><Link href="/request" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Mulai Project Baru</Link></li>
              <li><Link href="/login" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Client Portal</Link></li>
            </ul>
          </div>
