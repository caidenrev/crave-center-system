          ...
          {selectedNotif ? (
            ...
            <>
              <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex items-center gap-3 bg-slate-50/50 dark:bg-slate-900/50">
                ...
                <h3 className="font-semibold text-slate-900 dark:text-white">Detail Notifikasi</h3>
              </div>
              <div className="p-5 overflow-y-auto">
                ...
                <div className="text-xs text-slate-400 font-medium mb-6">
                  {new Date(selectedNotif.createdAt).toLocaleDateString()} pukul {new Date(selectedNotif.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                </div>
                  ...
                  <div className="divide-y divide-slate-100 dark:divide-slate-800/50">
                    {notifications.map(notif => (
                      <div 
                        ...
                        className={`p-4 cursor-pointer transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50 ${!notif.isRead ? 'bg-red-50/20 dark:bg-red-900/10' : ''}`}
                      >
